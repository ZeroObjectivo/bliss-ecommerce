 ...
 <button class="mobile-nav-toggle"
      aria-label="Toggle navigation">
        ...
        <div class="nav-actions">
            ...
            <a href="/php/Webdev/public/favorites" class="icon-link fav-link" aria-label="Favorites" style="position: relative;">
                ...
                ?>
                <span class="cart-badge fav-badge" style="background: #ef4444; top: -6px; right: -8px; display: <?= $favCount > 0 ? 'flex' : 'none' ?>;"><?= $favCount ?></span>
            </a>            <a href="/php/Webdev/public/cart" class="icon-link cart-link" aria-label="Cart">
